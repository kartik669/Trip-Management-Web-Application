          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div 
                ...
                className={`flex cursor-pointer items-center gap-3 rounded-lg border p-3 ${!isShared ? 'border-blue-600 bg-blue-50 ring-1 ring-blue-600' : 'border-gray-300 bg-white hover:bg-gray-50'}`}
              >
                <Lock className={`h-5 w-5 ${!isShared ? 'text-blue-600' : 'text-gray-500'}`} />
                <div>
                  <p className={`text-sm font-semibold ${!isShared ? 'text-blue-900' : 'text-gray-900'}`}>Personal</p>
              ...
              >
                ...
                <div>
                  <p className={`text-sm font-semibold ${isShared ? 'text-blue-900' : 'text-gray-900'}`}>Group</p>
